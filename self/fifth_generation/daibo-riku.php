...
<div class="max-w-3xl mx-auto">
    <div class="text-center mb-10">
        <img src="../../img/daibo-riku.jpg" alt="大坊凌功" class="w-36 h-36 rounded-full object-cover mx-auto mb-4 border-2 border-slate-100">
        <h1 class="text-2xl font-bold text-slate-800">大坊 凌功</h1>
    ...
    <section class="mb-6">
        ...
        <div class="flex flex-wrap gap-2">
            ...
            <span class="bg-slate-100 text-slate-800 px-3 py-1 rounded-full text-xs">Node.js</span>
        </div>
    </section>
