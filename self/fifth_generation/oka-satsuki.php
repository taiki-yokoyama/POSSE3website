...
<div class="max-w-3xl mx-auto">
    <div class="text-center mb-10">
        <img src="../../img/oka-satsuki.jpg" alt="岡颯己" class="w-36 h-36 rounded-full object-cover mx-auto mb-4 border-2 border-slate-100">
        <h1 class="text-2xl font-bold text-slate-800">岡 颯己</h1>
    ...
    <section class="mb-6">
        ...
        <div class="bg-slate-50 p-4 rounded">
            <p class="text-sm text-slate-700">ソフトウェア工学の基礎を学びつつ、アルゴリズムとデータ構造の理解を深めています。将来的にはサービス開発に携わりたいです。</p>
        </div>
    </section>
