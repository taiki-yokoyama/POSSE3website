...
<div class="max-w-3xl mx-auto">
    <div class="text-center mb-10">
        <img src="../../img/ishikawa-haruto.jpg" alt="石川遥登" class="w-36 h-36 rounded-full object-cover mx-auto mb-4 border-2 border-slate-100">
        <h1 class="text-2xl font-bold text-slate-800">石川 遥登</h1>
